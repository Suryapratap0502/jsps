            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><?= $model_short_name;?> Listing</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php base_url() ?>Dashboard">Dashboards</a></li>
                                <li class="breadcrumb-item active"><?= $model_short_name;?> Listing</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1"><?= $short_name;?> Listing</h4>
                        ...
                        <div class="card-body border border-dashed border-end-0 border-start-0">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 shift_left">
                                    <p></p>
                                    <?php date_default_timezone_set('Asia/Kolkata');
                                ...
                                <?php if ($model_short_name == 'services' || $model_short_name == 'renewals') { ?>
                                    <div class="col-md-2 col-sm-2">
                                        ...
                                        <div>
                                            <input type="date" class="form-control" name="exp_start_date" id="exp_start_date" onchange="expiry_datefilter();" placeholder="Select Start date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-2">
                                        ...
                                        <div>
                                            <input type="date" class="form-control" name="exp_end_date" id="exp_end_date" onchange="expiry_datefilter();" placeholder="Select End date">
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                                                                  ...
                                                                  <div class="col-md-2 setmodulwid">
                                                                        ...
                                                                        <h5 class="seth5"><b>
                                                                                <?php if (!empty($row->updated_at)) { ?>
                                                                                    <?php 
                                                                                     $date_of_update = date("d-m-Y", strtotime($row->updated_at));
                                                                                      echo $row->updated_at; ?>
                                                                                <?php } else {
                                                                                    echo "NA";
                                                                                }?>
                                                ...
                                                <ul class="pagination pagination-separated pagination-sm justify-content-center justify-content-sm-start mb-0">
                                                    ...
                                                    <?php for ($i = 0; $i < ($count / 10); $i++) { ?>
                                                        <li class="page-item <?php if (($uri == '') && ($i + 1 == 1)) {
                                                           ...
                                                           <a href="<?= base_url() ?><?= $short_name; ?>/index/<?= $model_short_name; ?>/<?= $i + 1 ?>" class="page-link" style="<?php if ($uri == '') {
                                                                                                                                                                                        if ($i + 1 == 1) {
                                                    ...
                                                    <?php if ($i > $uri) { ?>
                                                        <li class="page-item">
                                                           <a href="<?= base_url() ?><?= $short_name; ?>/index/<?= $model_short_name; ?>/<?= $uri + 1 ?>" class="page-link">→</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
