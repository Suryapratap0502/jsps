                                    ...
                                    <div class="card-body border border-dashed border-end-0 border-start-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 col-sm-6">
                                                <div class="input-group">
                                                  ...
                                                  <?php  }} ?>
                                                    ...
                                                    <?php if(!empty($team_leader)){foreach($team_leader as $com){ ?>
                                                        <option value="<?=$com['id']?>"><?=$com['name']?></option>
                                            ...
                                            <div class="col-md-1 col-sm-2">
                                                <div>
                                                <a href="<?=base_url()?>report/exportexcel_report_opration" class="btn btn-primary" style="float: right;"><i class="ri-download-cloud-line"></i></a>
                                                </div>
                                            </div>
